...
powershell -NoProfile -ExecutionPolicy unrestricted -Command "(new-object System.Net.WebClient).DownloadFile('https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-sdk-165.0.0-windows-x86_64.zip', 'C:\grr_deps\google-cloud-sdk-165.0.0-windows-x86_64.zip')"
C:\Python27-x64\python.exe -m "zipfile" -e C:\grr_deps\google-cloud-sdk-165.0.0-windows-x86_64.zip C:\grr_deps
